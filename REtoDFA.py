...
class AutomataGUI:
    ...
    def initUI(self):
        ...
        self.bottomLabel = Label(parentFrame, text="Automata Theory Project")
    ...
    #Regix Finding and Handling here.
